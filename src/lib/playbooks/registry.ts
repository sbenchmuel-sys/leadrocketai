...
const PLAYBOOKS: Playbook[] = [
  ...
  },
  {
    ...
    tone_profile: {
      voice: "Confident, concise, ROI-driven, technically aware",
      do: [
        "Emphasize measurable impact",
        "Connect features to business outcomes",
        "Anticipate security and integration concerns",
        "Use structured formatting when helpful",
        "Show proof (case study, metric, example)",
      ],
      dont: [
        "Use vague 'innovative solution' language",
        "Overexplain features",
        "Use casual tone in mid/late-stage deals",
        "Make competitive attacks",
      ],
    },
    common_objections: [
      { name: "Budget / Timing", guidance: "Acknowledge constraint. Reframe around ROI and cost of delay. Offer lightweight next step. If future quarter mentioned, align with that timeline." },
      { name: "Security / Compliance", guidance: "Proactively offer documentation (SOC2, overview). Reassure transparently. Ask what specific requirements matter most." },
      { name: "Existing Competitor", guidance: "Position as differentiated or complementary. Focus on specific gap. Offer short comparison conversation." },
      { name: "Lost Momentum", guidance: "Restate original business case. Re-anchor value. Propose simple re-engagement step." },
    ],
    buying_signals: [
      "API/integration questions",
      "CTO/Head of Ops involvement",
    ...
    red_flags: [
      ...
      "Feature curiosity without problem urgency",
      "Just benchmarking",
    ],
    compliance_rules: [
