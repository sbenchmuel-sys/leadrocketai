            ...
            {forgotSent ? (
              <div className="space-y-4 text-center">
                <p className="text-sm text-muted-foreground">
                  Check your inbox at <span className="font-medium text-foreground">{forgotEmail}</span> for a password reset link.
                </p>
                <Button
                  variant="outline"
                  className="w-full"
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>AI-powered email automation for professionals</CardDescription>
        </CardHeader>
        <CardContent>
